...
{
    throw new InvalidCastException("Azure Content Safety: Endpoint ou API Key não foram configurados");
}
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Contact = new OpenApiContact
        {
            ...
            Url = new Uri("https://github.com/feanastacio")
        },
...
////Aplicar serviço cognitivo
////Habilita o serviço de moderador de conteúdo da Microsoft Azure
